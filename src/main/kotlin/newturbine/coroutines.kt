 ...
 *   newturbine.assertCallingContextIsNotSuspended()
 *
 ...
 *   newturbine.assertCallingContextIsNotSuspended() // fine
 *   takeLastScreen() // boom!
 * }
 * ```
 */
...
internal suspend fun contextTimeout(): Long {
  return currentCoroutineContext()[TurbineTimeoutElement]?.timeout ?: DEFAULT_TIMEOUT_MS
}
